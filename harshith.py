...
I can download video or audio from Youtube. Made by @MutyalaHarshith
Hit help button to find out more about how to use me</b>""",   
                            reply_markup=InlineKeyboardMarkup(
                                [[
                                        ...
                                        InlineKeyboardButton(
                                            "Channel", url="https://t.me/MutyalaHarshith")
                                    ],[
                                      InlineKeyboardButton(
                                            "Source Code", url="https://github.com/MutyalaHarshith/YouTubedl")
                                    ]]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html")

@MutyalaHarshith.on_message(filters.command("help"))
async def help(client, message):
    if message.chat.type == 'private':   
        await MutyalaHarshith.send_message(
               chat_id=message.chat.id,
               text="""<b>YouTube DL BoT Help!
...
@MutyalaHarshith.on_message(filters.command("about"))
async def about(client, message):
    if message.chat.type == 'private':   
        await MutyalaHarshith.send_message(
               chat_id=message.chat.id,
               text="""<b>About YouTube DL!</b>
<b>• Develoveper:</b> <a href="https://t.me/MutyalaHarshith">Mutyala Harshith</a>
<b>• Support:</b> <a href="https://t.me/MHGchat">MHGroup Chat</a>
...
@MutyalaHarshith.on_message(filters.private
                   & filters.text
                   & ~filters.edited
...
@MutyalaHarshith.on_callback_query(filters.regex("^ytdl_audio$"))
...
async def send_audio(message: Message, info_dict, audio_file):
    ...
    title = '@MutyalaHarshith - '+s2tw(info_dict['title'])
...
@MutyalaHarshith.on_callback_query(filters.regex("^ytdl_video$"))
